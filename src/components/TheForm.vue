<template>
  <form @submit.prevent="submitForm">
    <div class="form-control" :class="{invalid:userValidity === 'invalid'}">
      ...
      <p v-if="userValidity === 'invalid' ">this filed is empty please write something!</p>
    </div>
    ...
    <div class="form-control">
      ...
      <div>
        <input id="interest-news" name="interest" type="checkbox" value="new" v-model="interest" />
    ...
    <div class="form-control">
      ...
      <div>
        <input id="how-other" name="how" type="radio" value="Other" v-mode="how" />
    ...
    <div>
      <input type="checkbox" name="conform" v-model="conform">
      <label for="conform">You really conform this?</label>
    </div>
    <div>
...
<script>
import RatingControl from './RateingControl.vue'
export default {
  data() {
    return {
      userName:'',
